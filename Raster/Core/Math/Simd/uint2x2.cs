...
namespace Raster.Core.Math.Simd
{
    ...
    public partial struct uint2x2 : System.IEquatable<uint2x2>, IFormattable
    {
        ...
        /// <summary>Returns the result of a componentwise left shift operation on a uint2x2 matrix by a number of bits specified by a single int.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2x2 operator << (uint2x2 x, int n) { return new uint2x2 (x.c0 << n, x.c1 << n); }
        /// <summary>Returns the result of a componentwise right shift operation on a uint2x2 matrix by a number of bits specified by a single int.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2x2 operator >> (uint2x2 x, int n) { return new uint2x2 (x.c0 >> n, x.c1 >> n); }
        /// <summary>
        ...
        /// <summary>
        /// Returns a hash code for the uint2x2.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
