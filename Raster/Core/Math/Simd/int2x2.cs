...
/t/t/// </summary>
        ...
        /// <summary>Returns the result of a componentwise left shift operation on an int2x2 matrix by a number of bits specified by a single int.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x2 operator << (int2x2 x, int n) { return new int2x2 (x.c0 << n, x.c1 << n); }

        /// <summary>Returns the result of a componentwise right shift operation on an int2x2 matrix by a number of bits specified by a single int.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x2 operator >> (int2x2 x, int n) { return new int2x2 (x.c0 >> n, x.c1 >> n); }
...
/t/t/// </summary>
        ...
        /// <summary>
        /// Returns a hash code for the int2x2.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public static partial class math
    {
        ...
        /// <summary>\n\t\t/// Returns the determinant of a int2x2 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
