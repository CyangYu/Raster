...
namespace Raster.Core.Math.Simd
{
    public static partial class math
    {
        ...
        /// <summary>
        /// Returns the bit pattern of a float2 as an int2.uiuu
		/// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		/// </summary>
        /// <param name="value"\>
		/// The input bool4 to calculate the bitmask for</param>
        ...
        /// <summary>
		/// Returns the componentwise reciprocal square root of a float4 vecto.
		/// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Conditionally flips a vector n to face in the direction of i. Returns n if dot(i, ng) < 0, -n otherwise.
		/// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
