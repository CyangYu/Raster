...
namespace Raster.Math
{
    ...
    public static class MathHelper
    {
        ...
        /// <param name="z"></param>
        /// <param name="w"></param>
        public static void Normalize(ref float x, ref float y, ref float z, ref float w)
        {
        ...
        /// <param name="rw"></param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Normalize(float x, float y, float z, float w, out float rx, out float ry, out float rz, out float rw)
        {
            float lenSqr = x * x + y * y + z * z + w * w;
